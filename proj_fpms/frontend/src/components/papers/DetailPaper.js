...
export class DetailPaper extends Component {
    ...
    render() {
        return (
                ...
                <h1 className="display-4">{this.props.paper.title}</h1>
                <hr className="my-4" />
            ...
            <p>Authors: {this.props.paper.authors}</p><br />
            <p>Publication Date:{this.props.paper.publication_date}</p><br/>
            <p>Publisher:{this.props.paper.publisher}</p><br />
            <p>Description:{this.props.paper.description}</p><br />
            {(this.props.paper.conference)?<p>Conference:{this.props.paper.conference_name + ", " +this.props.paper.location }</p>:""}
            ...
            <p>Link: <a href ={this.props.paper.paper_link}>{this.props.paper.paper_link}</a></p> <br/>
